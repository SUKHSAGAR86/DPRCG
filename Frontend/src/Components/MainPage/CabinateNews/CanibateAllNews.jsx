...
const CabinateAllNews = () => {
  const [cmNewsData, setCabinateNewsData] = useState([]);
    ...
    <div>
      ...
      <div className="pt-3" style={{ backgroundColor: "rgb(244, 248, 248)" }}>
        <div className="text-center mb-5">
          <h3 className="fw-bold p-2 bg-info-subtle fw-bold bi-people-fill">
            &nbsp; मंत्री मंडल समाचार
          </h3>
        </div>
                ...
                <div className="card shadow-lg rounded-2 h-100">
                  <div className="d-flex flex-column flex-md-row bg-white overflow-hidden rounded-2 h-100">
                    <img
                      ...
                      alt={news.title_hindi || "मंत्री मंडल समाचार"}
                      className="img-fluid"
                      style={{
                        width: "100%",
                        maxWidth: "12rem",
...
export default CabinateAllNews;

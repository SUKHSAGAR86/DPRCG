...
const PhotoGallerySection = () => {
  ...
  return (
    <div className="photo-gallery-wrapper py-4">
      <div className="container-fluid px-4" style={{ backgroundColor: '#f5f5f5', border: '10px solid black', borderRadius: '12px' }}>
        <div className="row g-4">

          {/* Photos */}
          <div className="col-12 col-sm-6 col-lg-3">
            <div className="card gallery-card position-relative overflow-hidden shadow-sm border-0">
              <img src={photo1} alt="Photos" className="img-fluid gallery-img" />
          ...
          <div className="col-12 col-sm-6 col-lg-3">
            <div className="card gallery-card position-relative overflow-hidden shadow-sm border-0">
              <img src={photo2} alt="Yojnas" className="img-fluid gallery-img" />
              <div className="black-overlay"></div>
              <div className="position-absolute top-50 start-50 translate-middle z-index-btn">
                <button
                  className="btn btn-warning fw-bold px-4 py-2 PhotosectionButton"
          ...
          <div className="col-12 col-sm-6 col-lg-3">
            <div className="card gallery-card position-relative overflow-hidden shadow-sm border-0">
              <img src={photo1} alt="Videos" className="img-fluid gallery-img" />
              <div className="black-overlay"></div>
              <div className="position-absolute top-50 start-50 translate-middle z-index-btn">
                <button
                  className="btn btn-warning fw-bold px-4 py-2 PhotosectionButton"
          ...
          <div className="col-12 col-sm-6 col-lg-3">
            <div className="card gallery-card position-relative overflow-hidden shadow-sm border-0">
              <img src={photo4} alt="Events" className="img-fluid gallery-img" />
              <div className="black-overlay"></div>
              <div className="position-absolute top-50 start-50 translate-middle z-index-btn">
                <button
                  className="btn btn-warning fw-bold px-4 py-2 PhotosectionButton"
